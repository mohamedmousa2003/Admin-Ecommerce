...
import 'package:admin_e_commerce/screens/loading_manager.dart';
    ...
    if (isValid) {
      ...
      try {
        ...
        await MyAppMethods.showErrorORWarningDialog(
            context: context,
            subtitle: " product Added Clear form?",
            fct: () {
              clearForm();
            });
  ...
  Future<void> _editProduct() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance
        ...
        'productTitle': _titleController.text,
        'productPrice': _priceController.text,
        'productImage': productImageUrl ?? widget.productModel!.productImage,
        'productCategory': _categoryValue,
        'productDescription': _descriptionController.text,
        'productQuantity': _quantityController.text,
      ...
      await MyAppMethods.showErrorORWarningDialog(
        context: context,
        subtitle: "Product Updated. Do you want to clear the form?",
        fct: () {
          clearForm();
        },
      );
